        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <Link
              ...
              className="group block rounded-sm border border-line p-8 transition-colors hover:border-blue-bright md:col-span-2 md:row-span-1"
            >
            ...
            <Link
              ...
              className="block rounded-sm border border-line p-8 transition-colors hover:border-blue-bright"
            >
